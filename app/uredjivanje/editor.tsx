      ...
      <div id="osnovno">
        <EditorSection title="Kontakt i Google kalendar" description="Mejl, telefon, društvene mreže i budući link za zakazivanje" open>
          <div className="editor-grid">
            ...
            <Field label="Viber link" value={content.global.viberUrl} onChange={(value) => updateContent((draft) => { draft.global.viberUrl = value; })} hint="Format: viber://chat?number=%2B381...&text=Vaša%20poruka. Kod ličnog Viber naloga sajt kopira pripremljenu poruku; korisnik je zatim nalepi u otvoreni razgovor." />
