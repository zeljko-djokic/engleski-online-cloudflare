      ...
      <div id="osnovno">
        <EditorSection title="Kontakt i Google kalendar" description="Mejl, telefon, društvene mreže i budući link za zakazivanje" open>
          <div className="editor-grid">
            ...
            <Field label="Viber Business link" value={content.global.viberUrl} onChange={(value) => updateContent((draft) => { draft.global.viberUrl = value; })} hint="Zvanični format: https://viber.me/broj?draft=Vaša%20poruka" />
